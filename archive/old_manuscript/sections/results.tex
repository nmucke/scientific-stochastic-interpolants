...
\begin{wraptable}{r}{0.5\linewidth}
    ...
    \begin{tabular}{l|cc}
        ...
        Ours (SI-SDE)        & 0.124 & 0.159 \\
        Ours (DM-SDE)        & 0.167 & 0.183 \\
        Ours (FM-ODE)        & 0.247 & 0.211 \\
        \midrule
        \multicolumn{3}{l}{\textit{Ours -- shared inflated covariance}} \\
        Ours (SI-SDE)        & \textbf{0.001} & \textbf{0.022} \\
        Ours (DM-SDE)        & 0.002 & 0.024 \\
        Ours (FM-ODE)        & 0.004 & 0.028 \\
        \midrule
        FlowDAS              & 3.73  & 0.437 \\
        FlowDAS + SURGE      & 8.47  & 0.515 \\
        SDA                  & 0.262 & 0.316 \\
        SDA + SURGE          & \textbf{0.001} & \textbf{0.021} \\
        D-Flow SGLD          & 0.511 & 0.428 \\
        Guided FM (FIG)      & $\sim\!10^{14}$ & 0.719 \\
        EnKF                 & \textbf{0.001} & 0.020 \\
